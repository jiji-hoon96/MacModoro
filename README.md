...
```bash
brew tap jiji-hoon96/macmodoro https://github.com/jiji-hoon96/MacModoro
brew install --cask macmodoro
```

### 직접 다운로드

[Releases](https://github.com/jiji-hoon96/MacModoro/releases)에서 최신 zip 다운로드 → 압축 해제 → `MacModoro.app`을 Applications로 이동
...
git clone https://github.com/jiji-hoon96/MacModoro.git
cd cozyScreen
xcodegen generate
